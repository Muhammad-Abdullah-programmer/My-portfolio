...
allProductCards.innerHTML = allProducts.map((product, index)=>{
 ...
 <div class=" aspect-square flex justify-center items-center  h-20vh">
    ...
    <div  class=" flex justify-center items-center gap-2 bottom-12 left-0 px-2   transform translate-y-5 opacity-0 group-hover:opacity-100 group-hover:-translate-y-0 transition ease-in-out duration-300 bg-white h-[12%] w-[100%] absolute">
