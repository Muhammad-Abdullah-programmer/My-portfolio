export default function MediaCards({filter}){
    ...
    return(
        ...
        <div className="cards my-6 py-4  px-4 gap-4    grid md:grid-cols-3 grid-cols-1 ">

            {/* Card 1  */}
            <div className={` ${ filter === "all" || filter === "ai" ? "block md:flex" : "hidden"} card-1 bg-[#ffffff0f] md:col-span-1 rounded-2xl  md:flex-col md:justify-between`}>
            ...
            {/* Card 2  */}
            <div className={` ${ filter === "all" || filter === "automation" ? "block md:flex" : "hidden" } card-1 bg-[#ffffff0f] md:col-span-1 rounded-2xl md:flex-col md:justify-between `}>
            ...
            {/* Card 3  */}
  <div className={`${filter === "all" || filter === "caseStudy" ? "block md:flex" : "hidden"} card-1 bg-[#ffffff0f] md:col-span-1 rounded-2xl  md:flex-col md:justify-between`}>
            ...
            {/* Card 4  */}
  <div className={`${filter === "all" || filter === "companyNews" ? "block md:flex" : "hidden"} card-1 bg-[#ffffff0f] md:col-span-1 rounded-2xl md:flex-col md:justify-between`}>
