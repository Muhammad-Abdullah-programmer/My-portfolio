...
<div className="aboutme w-[80%] h-full mx-auto py-4 flex flex-col items-center md:flex-row md:items-center md:justify-between ">
    ...
    {/* About Me Text  */}
    <div className="about-me-text w-[100%] text-[#ffff]  h-[100%]  mt-4  flex flex-col justify-between md:justify-center md:gap-4  overflow-hidden">
   <div className="about-me-text w-[100%] h-[90%] md:h-auto overflow-hidden ">
...
{/* Button  */}
<a href='' className=' text-center bg-gradient-to-r from-[#3088ec] to-[#f0413f] md:mt-0 w-40 px-3 py-2 rounded-2xl font-semibold'>Download Resume </a>
    </div>
</div>
        </section>
